...
const Tooltip = factory.factory((_props, ref) => {
  ...
  if (target) {
    const transition2 = getTransitionProps.getTransitionProps(transitionProps, { duration: 100, transition: "fade" });
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: /* @__PURE__ */ jsxRuntime.jsx(OptionalPortal.OptionalPortal, { ...portalProps, withinPortal, children: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  const targetRef = hooks.useMergedRef(tooltip.reference, getRefProp.getRefProp(child), ref);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    React.cloneElement(
      ...
      tooltip.getReferenceProps({
        ...
        ...childProps,
        className: cx__default.default(className, childProps.className),
        [refProp]: targetRef
      })
    )
  ] });
